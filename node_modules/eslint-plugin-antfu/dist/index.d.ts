...
declare const _default: {
    rules: {
        ...
        'top-level-function': _typescript_eslint_utils_dist_ts_eslint_Rule.RuleModule<"topLevelFunctionDeclaration", [], _typescript_eslint_utils_dist_ts_eslint_Rule.RuleListener>;
        'no-cjs-exports': _typescript_eslint_utils_dist_ts_eslint_Rule.RuleModule<"noCjsExports", [], _typescript_eslint_utils_dist_ts_eslint_Rule.RuleListener>;
        'no-ts-export-equal': _typescript_eslint_utils_dist_ts_eslint_Rule.RuleModule<"noTsExportEqual", [], _typescript_eslint_utils_dist_ts_eslint_Rule.RuleListener>;
    };
};
